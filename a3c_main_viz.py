...
from a3c_train_viz import train
from a3c_test_viz import test
...
if __name__ == '__main__':
    ...
    for rank in range(0, args.num_processes):
        ...
        p.start() # p.start() will start the function "run"
        processes.append(p)
    ...
    try:
        ...
        for p in processes:
            p.terminate() # when interrupt the processes by "ctrl c", use terminate to end them
